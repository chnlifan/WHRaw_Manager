...
{
    public class ControlThemeBoard
    {
        ...
        static public readonly DataGridViewCellStyle ColumnHeaderCellStyle = new DataGridViewCellStyle
        {
            ...
            Font = new Font("微软雅黑", (float)(15.0F), FontStyle.Bold, GraphicsUnit.Point),
        ...
        static public DataGridViewCellStyle RowHeaderCellStyle = new DataGridViewCellStyle
        {
            ...
            Font = new Font("微软雅黑", (float)(8.0F), FontStyle.Bold, GraphicsUnit.Point),
                                                     ...
                                                     bool isautosizerows = true)
        {
            ...
            //网格线颜色
            grid.GridColor = Color.LightGray;   //SystemColors.GradientInactiveCaption;
            //grid.Font = ColumnHeaderCellStyle.Font;

            //设置datagridview行列的适应模式
            if (fillsizecolumnsmode == true) grid.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
